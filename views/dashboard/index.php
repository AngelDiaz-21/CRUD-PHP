<?php
    $expenses             = $this->datos['expenses'];
    $totalThisMonth       = $this->datos['totalAmountThisMonth'];
    $maxExpensesThisMonth = $this->datos['maxExpensesThisMonth'];
        ...
        <div id="expenses-container" class="container">
            ...
            <div id="right-container">
                <div class="transactions-container">
                    ...
                    <?php
                            if($expenses === NULL){
                                echo('Error al cargar los datos correspondientes');
