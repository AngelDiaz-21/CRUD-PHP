...
<body>
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="card text-left">
						<div class="card-body">
							<form id="formCreate" onsubmit="return actualizarDatos(<?php echo $this->estudiante[1];?>)" method="post">
								<div class="row">
									<div class="col-12 col-md-6">
										<div class="form-group">
											<label class="mb-2" for="matricula">Matricula</label>
											<input type="text" name="matricula" class="form-control" maxlength="15" 
											placeholder="Ingrese su matricula" value="<?php echo $this->estudiante[1];?>" required readonly>
											<span></span>
										</div>
									</div>
									<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											...
											<input type="text" name="nombre" class="form-control" maxlength="30"  placeholder="Ingrese su nombre" value="<?php echo $this->estudiante[2];?>" required>
											<span></span>
										</div>
									</div>
									<div class="col-12 col-md-6">
										<div class="form-group">
											...
											placeholder="Ingrese su apellido paterno" value="<?php echo $this->estudiante[3];?>" required>
											<span></span>
										</div>
									</div>
									<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											...
											<input type="text" name="apellido_m" class="form-control" maxlength="20" placeholder="Ingrese su apellido materno" value="<?php echo $this->estudiante[4];?>" required>
											<span></span>
										</div>
									</div>
	...
	<script src="<?php echo constant('URL');?>librerias/sweetalert.min.js"></script>
	<script src="<?php echo constant('URL');?>js/crudEstudiantes.js"></script>
</body>
</html>