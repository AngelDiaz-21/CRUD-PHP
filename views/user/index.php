            ...
            <div id="user-header">
                <div id="user-info-container">
                    ...
                    <?php if($user->getPhoto() != ''){?>
                        <img src="public/img/photos/<?php echo $user->getPhoto(); ?>" width="200" alt="">
                    <?php } ?>
                    </div>
                    <div id="user-info">
                        ...
                        <div class="section">
                            <label for="photo">Foto de perfil</label>
                                <?php if(!empty($user->getPhoto())){?>
                                    <img src="<?php echo constant('URL'); ?>public/img/photos/<?php echo $user->getPhoto(); ?>" width="50" height="50" alt="">
                                <?php
                                }
                                ?>
